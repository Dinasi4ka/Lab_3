...
public class Receipt {
    ...
    public void printReceipt() {
        if (isPaid) {
            System.out.println("task.Receipt: " + this.date);
            System.out.println("task.Customer: " + this.customer.getName());
            System.out.println("Products: ");
            this.products.forEach(product -> System.out.println(product.getName() + ", type " + product.getType()));
            commentToCheck();
        } else {
            System.out.println("task.Receipt is not paid.To see receipt pay it.");
        }
    }
    ...
    public void editReceipt(Customer newCustomer, List<Product> newProducts, LocalDate newDate) {
        if (!isPaid) {
            ...
            this.date = newDate;
            System.out.println("task.Receipt edited successfully.");
        } else {
