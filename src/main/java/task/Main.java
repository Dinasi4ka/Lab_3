...
public class Main {
    public static void main(String[] args) throws ProductNotAvailableException, FileReadException, WriteReceiptException {
        ...
        List<Product> readProducts = FileService.readProductsFromFile("all_products.txt");
        ...
        Receipt receipt1 = new Receipt(new Customer("Mykola"), productList1, LocalDate.of(2021, 10, 10));
        receipt1.payReceipt();
        receipt1.printReceipt();

        fileService.writeReceiptToFile( receipt1,"receipt");

        Receipt receipt2 = new Receipt(new Customer("Ivan"), productList1, LocalDate.of(2023, 10, 11));
        receipt2.printReceipt();
        receipt2.payReceipt();

        fileService.writeReceiptToFile( receipt2,"receipt1");
    }
}
